...
public final class GeradorCpf {
    ...
    public String cpf(boolean comPontos, String... createdCpfs) {
        String generated = cpf(comPontos);
        for (String createdCpf : createdCpfs) {
            if (generated.equals(createdCpf)) cpf(comPontos, createdCpfs);
        }
        return generated;
    }

    public String cpf(boolean comPontos, Set<String> createdCpfs) {
        String generated = cpf(comPontos);
        while (createdCpfs.contains(generated)) {
            generated = cpf(comPontos);
        }
        return generated;
    }
